                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Product name" wire:model.dafer="product_name">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                ...
                                                                <input type="color" name="product_name" class="form-control mb-2" placeholder="Color" wire:model.dafer="color">
                                                            ...
                                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="desc" wire:model.dafer="desc">
                                                                @error('desc') <span class="alert alert-danger" role="alert">{{ $message }}</span> @enderror
                                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                <label class="required form-label">Email</label>
                                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Email" wire:model.dafer="email">
                                                                @error('email') <span class="alert alert-danger" role="alert">{{ $message }}</span> @enderror
                                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                <label class="required form-label">Password</label>
                                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Password" wire:model.dafer="password">
                                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                        </div>
                                                    </div>
                                                </div>
