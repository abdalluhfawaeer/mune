<tr>
    ...
    <td> 
        <input type="text" class="form-control" style="width: 200px !important;"
        ...
        <table class="fw-semibold text-gray-600">
            @foreach ($acc as $value => $key)
                <tr>
                    ...
                    <td>
                        <a href="#" wire:click="deleteAcc({{ $value }})" class="btn btn-icon btn-danger btn-sm">
    ...
    <td>
        <a wire:click="update({{ $item->id }})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="blank">
            <span class="svg-icon svg-icon-3">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
