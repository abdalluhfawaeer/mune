    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
                            ...
                            <div class="card-body text-center pt-0">
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true" style="<br /> <b>Warning</b>: Undefined variable $imageBg in <b>/var/www/preview.keenthemes.com/kt-products/metronic/releases/2022-07-14-092914/core/html/dist/view/pages/apps/ecommerce/catalog/edit-product/_thumbnail.php</b> on line <b>30</b><br />">
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-kt-initialized="1">
                                        ...
                                        <input type="file" name="avatar" accept=".png, .jpg, .jpeg" wire:model.dafer="photo">
                                ...
                                @error('photo') <span class="alert alert-danger" role="alert">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="card card-flush py-4">
                            <div class="card-header">
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel" wire:ignore.self>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Product name" wire:model.defer="name_ar">
                                                <br>
                                            ...
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Product name" wire:model.dafer="name_en">
                                                <br>
                                            ...
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <select class="form-control form-control-solid" wire:model.dafer="cat">
                                                    <option value="" selected>Category</option>
                                                    @foreach ($category as $cat)
                                                    <option value="{{ $cat->id }}" selected >{{ $cat->name_ar }}</option>
                                                @endforeach
                                                </select> 
                                            </div>
                                            @error('cat') <span class="alert alert-danger" role="alert">{{ $message }}</span> @enderror                                             
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="kt_ecommerce_add_product_advanced" role="tab-panel" wire:ignore.self>
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="card card-flush py-4">
                                        <div class="card-header">
                                            <div class="card-title">
                                                ...
                                                <div id="kt_ecommerce_add_product_options">
                                                        ...
                                                        <div data-repeater-list="kt_ecommerce_add_product_options" class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="Title ar" wire:model='title.0'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="Title en" wire:model='title_en.0'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                                    <select class="form-control form-control-solid" wire:model.dafer="req.0">
                                                                        <option value=""></option>
                                                    ...
                                                    <div class="form-group p-5">
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.0'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.1'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.2'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.3'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                            ...
                                            <div class="">
                                                ...
                                                <div id="kt_ecommerce_add_product_options">
                                                    <div class="form-group">
                                                        <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="Title ar" wire:model='title.1'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="Title en" wire:model='title_en.1'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                                <select class="form-control form-control-solid" wire:model.dafer="req.1">
                                                                    <option value=""></option>
                                                    ...
                                                    <div class="form-group p-5">
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.4'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.5'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.6'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.7'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                            ...
                                            <div class="">
                                                ...
                                                <div id="kt_ecommerce_add_product_options">
                                                    <div class="form-group">
                                                        <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="Title ar" wire:model='title.2'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="Title en" wire:model='title_en.2'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                                <select class="form-control form-control-solid" wire:model.dafer="req.2">
                                                                    <option value=""></option>
                                                                    <option value="1" selected>required</option>
                                                                    <option value="0">not required</option>
                                                                </select>                                                                
                                                    ...
                                                    <div class="form-group p-5">
                                                        <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.8'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                            <div class="w-100 w-md-200px">
                                                                <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.9'>
                                                            </div>
                                                            <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.10'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
                                                        ...
                                                        <div class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                <div class="w-100 w-md-200px">
                                                                    <input type="text" class="form-control mw-100 w-200px" placeholder="name ar" wire:model='name.11'>
                                                                </div>
                                                                <div class="w-100 w-md-200px">
