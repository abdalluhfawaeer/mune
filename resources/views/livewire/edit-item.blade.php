                                                        ...
                                                        <div data-repeater-list="kt_ecommerce_add_product_options" class="d-flex flex-column gap-3">
                                                            <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <button class="btn btn-success btn-sm" wire:click.prevent="add2({{$value}},{{ $y}})"><i class="fa-sharp fa-solid fa-plus"></i></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            @foreach ($inputs_a[$value] as $key2 => $values)
                                                                <div class="d-flex flex-column gap-3">
                                                                    <div class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <button class="btn btn-danger btn-sm" wire:click.prevent="remove2({{$key2}},{{ $value }})"><i class="fa-sharp fa-solid fa-trash"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <br>
