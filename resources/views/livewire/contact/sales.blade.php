                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{ __('text.requestssales') }}
                                            ...
                                            <table
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="d-flex">
                                                            <a href="/admin/sales/edit/{{ $item->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="blank">
