                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{ __('text.requestsmenu') }}
                                            ...
                                            <table
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td data-kt-ecommerce-order-filter="order_id">
                                                            <a class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $item->subject }}</a>
                                                        </td>
                                                        <td data-kt-ecommerce-order-filter="order_id">
                                                        ...
                                                        {{-- <td class="d-flex">
                                                            <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="blank">
